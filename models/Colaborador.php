...
class Colaborador extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['rutColaborador', 'dvColaborador', 'pass', 'nombreColaborador', 'apellidosColaborador', 'idSucursal', 'idArea', 'idCargo', 'idRol', 'idGerencia', 'idperfil', 'idestado', 'idCC', 'correo'], 'required'],
            [['rutColaborador', 'idSucursal', 'idArea', 'idCargo', 'idRol', 'idGerencia', 'westadoJefe', 'idperfil', 'idestado', 'idCC'], 'integer'],
            [['dvColaborador'], 'string', 'max' => 1],
            [['pass'], 'string', 'max' => 50],
            [['nombreColaborador', 'apellidosColaborador', 'direccion'], 'string', 'max' => 200],
            [['correo', 'telefono'], 'string', 'max' => 45],
            [['rutColaborador', 'idSucursal', 'idArea', 'idCargo', 'idRol', 'idGerencia', 'idperfil', 'idperfilRed', 'idestadisticas', 'idestado', 'idCC'], 'unique', 'targetAttribute' => ['rutColaborador', 'idSucursal', 'idArea', 'idCargo', 'idRol', 'idGerencia', 'idperfil', 'idestado', 'idCC']],
